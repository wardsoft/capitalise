...
if( ! class_exists( 'PTF_Widgets_Block' ) ) :
     
    class PTF_Widgets_Block extends AQ_Block {
    	
    	function __construct() {
    		$block_options = array(
    			'name' => __('Widgets', 'artcore'),
    			'size' => 'span4',
    		);
    		
    		parent::__construct( 'PTF_Widgets_Block', $block_options );
    	}
    	...
    	function form($instance) {
    		...
    		<p class="description half last">
    			<label for="">
    				<?php _e('Choose Widget Area', 'artcore'); ?><br/>
    ...
    aq_register_block( 'PTF_Widgets_Block' );
