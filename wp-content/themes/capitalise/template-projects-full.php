 ...
 * Projects Full Width Template File.
 *
...
<div class="projects">
	...
	<div class="container-fluid">
		<div class="projects-grid">
			<div class="row" id="projects-grid">
                ...
                <div class="col-md-4 col-sm-6 project-item <?php echo esc_attr( $project_cats ); ?>">
	...
	<?php
    	// Print extra margin for navigation in template projects full layout
        if ( $wp_query->max_num_pages > 1 ) {
            echo '<div class="spacer-30 clearfix"></div>';
        } ?>
